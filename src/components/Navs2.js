...
var LINKS = [
    { to: "/Abouabdallah/#about", text: "About", inside: true, to1: "about" },
    { to: "/Abouabdallah/experience", text: "Experience", inside: false},
    { to: "/Abouabdallah/#publications", text: "Publications", inside: true, to1: "publications" },
    { to: "/Abouabdallah/#projects", text: "Projects", inside: false },
    { to: "/Abouabdallah/resume", text: "Resume", inside: false },
    { to: "/Abouabdallah/contact", text: "Contact", inside: false },
    { to: "/Abouabdallah/chatbot", text: "My own chatbot", inside: false },
];
    ...
    return (
      <header>
        ...
        <nav className="navigation">
            ...
            <NavLink to="/#home"><img src='/Abouabdallah/Images/signature.jpeg' alt="logo" className="logo-hover" /></NavLink>
